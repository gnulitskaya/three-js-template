...
export default class LandingPage extends EventEmitter {
    ...
    hide() {
        // !this.experience.ui.menu.main.visible && !this.experience.ui.menu.main.isAnimating && !this.transiton.isShowing
        if (this.visible && !this.isAnimating && this.reopeningEnabled) {
            this.visible = false
    ...
    show() {
        // && !this.transiton.isShowing && this.reopeningEnabled
